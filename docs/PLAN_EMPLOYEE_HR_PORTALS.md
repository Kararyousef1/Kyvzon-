...
> **الحالة:** خطة مبنيّة على **قياس** لا انطباع. كل رقم أدناه استُخرج
...
- الموارد ↔ المالية: الرواتب · السلف · المصروفات
- الموارد ↔ التقنية: البصمة · الحضور
- الموارد ↔ الحركة: التصاريح
- الكل ↔ التواصل: الإشعارات (مُوحَّدة في `0326`)
