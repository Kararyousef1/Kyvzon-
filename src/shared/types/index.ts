...
export type UserRole = 'employee' | 'hr' | 'admin' | 'gatekeeper' | 'developer' | 'supervisor' | 'manager' | 'it_admin' | 'tech' | 'finance' | 'marketing' | 'sales' | 'procurement' | 'inventory' | 'manufacturing' | 'employee_movement' | 'logistics' | 'movement_manager';
